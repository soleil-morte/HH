...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main', '0002_remove_job_job_type_remove_user_password_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='cv',
            field=models.FileField(blank=True, null=True, upload_to='cvs/', validators=[django.core.validators.RegexValidator(message="Telefon raqam +998xxxxxxx fromatida bo'lishi kerak.", regex='^\\+998\\d{9}$')]),
        ),
        migrations.AlterField(
            model_name='user',
            name='phone',
